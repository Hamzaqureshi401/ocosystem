<div class="modal fade" id="showMsgModal" tabindex="-1"
	role="dialog" aria-labelledby="showMsgModal"
	aria-hidden="true">
<div class="modal-dialog modal-dialog-centered  mw-75 w-50"
	role="document">
	<div class="modal-content modal-inside bg-greenlobster">
		<div style="border:0" class="modal-header text-center"></div>
...
function deleteData(id) {
	const url = "{{ route('data.ajax.destoryFranchiseManagement',
		['model_id' => "MODEL_ID"]) }}".replace("MODEL_ID", id);
