...
<div class="modal fade oneWayModal" tabindex="-1" role="dialog"
    ...
    <div class="modal-content bg-greenlobster">
        <div class="modal-header">
            <h4 class="modal-title" id="myLargeModalLabel">One Way</h4>
        </div>
        <div class="modal-body">
            <form>
				...
				<div class="col-md-9">
					<input type="text" class="form-control" style="outline:none;" name="company_name">
				</div>
				</div>
                </div>
                <div class="form-group">
...
<div class="modal fade" id="merchant-location-modal" tabindex="-1"
	...
	<div class="modal-dialog modal-dialog-centered modal-md" role="document">
		<div class="modal-content bg-greenlobster"
			...
			<div class="modal-header">
				<h3 style="line-height:1.5em;margin-bottom:0">
					Default Location
				</h3>
			</div>
			<div class="modal-body">
