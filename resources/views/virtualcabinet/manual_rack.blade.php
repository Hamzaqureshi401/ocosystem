...
<div id="landing-content" style="width: 100%">
	...
	<div class="row py-2">
		<div class="col align-self-end" style="width:80%">
			<h2 style="margin-bottom: 15px;">Rack</h2>
		</div>
    <div class="modal" id="rackNameModal" style="margin-top:16%;">
        <div class="modal-dialog">
          <div class="modal-content">
            <!-- Modal body -->
            <div class="modal-body">
                <input id="rackNameInput" type="text" class="pl-1" style="width: 100%; border: 1px solid #ddd;">
            </div>
          </div>
        </div>
    </div>
    ...
    <div class="modal" id="repairAmountModal" style="margin-top:5%;">
        ...
        <button class="btn btn-success btn-log sellerbutton text-center" style="margin-right:0;    padding: 0;" id="addRackButton" > <span >+Rack</span>
      </button>
		</div>
    </div>
    ...
    <table class="table table-bordered display" id="repair_table" style="width:100%;">
          ...
          <tr>
              ...
              <th style="width:1%;text-align: center; white-space: nowrap;">Rack ID</th>
              <th>Rack Name</th>
              <th style="width: 1%; text-align: center; white-space: nowrap;">Date</th>
               <th style="width: 1%; text-align: center; white-space: nowrap;">File</th>
              <th style="width: 1%;"></th>
               </tr>
          </thead>
          <tbody>
...
<script type="text/javascript">
    ...
    $('#addRackButton').on( 'click', function () {
    tts_table.row.add([counter +'',
      '1',
      '<p class="rackNameOutput" data-toggle="modal"  data-target="#rackNameModal" style="color:#007bff;width100%;margin:0;">Rack</p>',
      '<p style="margin:0;">&nbsp19Jul19&nbsp00:32:54</p>',
      '<a href="/show-vcrack-file-view" id="file" target="_blank">0</a>',
...
<script type="text/javascript">
    $('table').on('click','tr p.rackNameOutput',function(e){
      e.preventDefault();
      $(".rackNameOutput").removeClass("rackNameOutputVal");
      $(this).addClass( 'rackNameOutputVal' );
      document.getElementById("rackNameInput").value = $(this).text();
        $("#rackNameInput").keyup(function(){
            var currentText = $(this).val();
            $(".rackNameOutputVal").text(currentText);
        });
    });
</script>
