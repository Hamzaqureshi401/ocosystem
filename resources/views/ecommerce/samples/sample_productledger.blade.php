...
<div class="modal-dialog modal-dialog-centered" role="document" >
    ...
    <div class="row" style="padding-top:0">
        <div class="col-sm-3" style="align-self:center">
            <h2 style="margin-bottom:0;padding-top: 0;">Product Ledger</h2>
        </div>
  ...
  <div class="table-responsive" style="overflow-x: hidden;">
    ...
    @foreach($opos_product as $key => $value)
        ...
        <td style="text-align: left; padding-left: 15px;" class="remarks" id='remark_{{$value->item_detail_id}}'>
          @if($value->stock) 
              <a title="{{$value->item_remarks}}" 
               href="#" 
               data-toggle="modal" 
               data-target="#remarks_qty" 
               data-item_id="{{$value->item_detail_id}}"
               data-item_remark="{{$value->item_remarks}}"
               data-remark_type='stock'>
      ...
      if(item_remark!="" || item_id!=""){
        $.ajax({
          ...
          success: function(dataResult){
            ...
            var remark_html = '<a href="#" title="'+item_remark+'"  data-toggle="modal" data-target="#remarks_qty" data-item_id="'+item_id+'" data-item_remark="'+item_remark+'" data-remark_type="'+remark_type+'">'+item_remark+'</a>';
