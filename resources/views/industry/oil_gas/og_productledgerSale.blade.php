        ...
        @foreach($data as $value)
            ...
            <tr>
                ...
                <td style="text-align: center;@if($value->void == 1) background-color: red; @endif">
                    @if($value->table_name == 'opos_receiptproduct')
                    <span onclick="show_receipt('{{$value->document_no}}')" class="os-linkcolor" style="cursor: pointer; margin: 0;display:inline-block;">{{$value->document_no}}</span>
                    @endif
                </td>
                <td style="text-align: center;" nowrap>
                    @if($value->table_name == 'opos_receiptproduct' && $value->void == 1)
                        Void Sales
                    @else
                         Cash Sales
                    @endif
