	...
	<div class="modal-content">
		...
		<form  class="m-form  m-form--state m-form--label-align-right " >
			<div class="modal-body">
                ...
                <textarea id="modal-item_remark" name="remark" class="form-control m-input"  placeholder="Remarks" rows="3"></textarea>
				</div>
			</div>
		</form>
	</div>
...
<div class="row"
	...
	<div class="col-sm-5" style="align-self:center">
		<h2 style="margin-bottom:8px;padding-top: 0;">
			Product Ledger: Fuel Movement Receipt
		</h2>
	</div>
              ...
              $type ="";
				if($value->table_name == 'stockreportproduct'){
                  ...
                  if($value->stock_report->type){
				   ...
				   Log::debug('RF type='.$type);

					if($str->is('stock*', $type)){

					  $type='Stock'.' '.$str->ucfirst(explode('stock',$type)[1]);
					} else if ($type == 'Cforward') {
						$type = 'C/Forward';
					} else {
