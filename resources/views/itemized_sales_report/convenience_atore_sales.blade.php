...
<body>
    ...
    <table border="0" cellpadding="0" cellspacing="0" class="table" id="item" style="margin-top: 5px; width:100%">
        ...
        <tr id="table-th" style="border-style: none">
            ...
            <th valign="middle" class="text-center" style="width:20%;">Product</th>
            <th valign="middle" class="text-left" style="width:15%">Price</th>
            <th valign="middle" class="text-center" style="width:10%;">Qty</th>
            <th valign="middle" class="text-center" style="width:15%;">Tax&nbsp;</th>
			<th valign="middle" class="text-center" style="width:15%;">Sales</th>
			<th valign="middle" class="text-center" style="width:15%;">Amount</th>
			<th valign="middle" class="text-center" style="width:15%;">Pay</th>
