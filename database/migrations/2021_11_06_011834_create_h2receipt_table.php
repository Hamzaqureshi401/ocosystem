...
class CreateH2receiptTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('h2receipt', function (Blueprint $table) {
			...
			* This is stored as percent e.g. 6.5% */
			...
			$table->enum('payment_type',
			  ['cash','creditcard','point','wallet','creditac'])->
			  default('cash');
