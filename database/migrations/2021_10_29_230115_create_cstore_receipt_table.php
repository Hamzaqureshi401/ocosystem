...
class CreateCstoreReceiptTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('cstore_receipt', function (Blueprint $table) {
            $table->bigIncrements('id');

			// Unique ID coming from a DB sequence, "csreceipt_seq"
    ...
    {
        Schema::dropIfExists('cstore_receipt');
    }
}
