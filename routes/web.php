...
include_once('custom/pdf_download_routes.php');
...
include_once('custom/evcharger_routes.php');

include_once('custom/ev_routes.php');
include_once('custom/h2_routes.php');
include_once('custom/cstore_routes.php');
include_once('custom/fuel_routes.php');

include_once('custom/itemizedsales_report_routes.php');
