...
<body>
    ...
    <table border="0" cellpadding="0" cellspacing="0" class="table" id="item" style="margin-top: 5px; width:100%">
       ...
       <?php $__currentLoopData = $get_receipts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $get_receipt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr class="table-td">
                <td class="text-center" style="border-style: none">
					<?php echo e($get_receipt->id); ?>

				</td>
                <td class="text-left" style="border-style: none">
					<?php echo e($get_receipt->name); ?>

				</td>
                <td class="text-center" style="border-style: none">
                    <?php echo e(number_format(($get_receipt->price/100) , 2)); ?>

                </td>
                <td style="text-align:center;border-style: none">
					<?php echo e(number_format($get_receipt->quantity , 2)); ?>

                </td>

                <td style="text-align:center;border-style: none">
                    <?php echo e(number_format(($get_receipt->sst/100) , 2)); ?>

                </td>
                 <td style="text-align:center;border-style: none">
                    <?php echo e(number_format($get_receipt->total , 2)); ?>

                </td>
                 <td style="text-align:center;border-style: none">
                    <?php echo e(number_format(($get_receipt->item_amount/100) , 2)); ?>

                </td>
                 <td style="text-align:center;border-style: none">
                 	<?php if($get_receipt->payment_type == "creditcard"): ?>
                    <?php echo e("Credit Card"); ?>

                    <?php else: ?>
                    <?php echo e(ucwords($get_receipt->payment_type)); ?>
...
<?php /**PATH E:\ocosystem\resources\views/itemized_sales_report/hydrogen_pdf.blade.php ENDPATH**/ ?>