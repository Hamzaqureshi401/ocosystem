	...
	<tbody>
		...
		<tr>
			...
			<a href="/"
				...
				onclick="openitemizeddsalereport(<?php echo e($location->systemid); ?>); return false;"
				><?php echo e($location->systemid); ?></a></td>
			<td class="text-left" id="branch-<?php echo e($location->systemid); ?>"> <?php echo e($location->branch); ?> </td>
...
function dateToYMDEmpty(date) {
   ...
   //      };
        ...
        var url = "<?php echo e(route('download.pdf')); ?>/"+startDate+"/"+endDate+"/"+view+"/"+system_id;
        window.open(url, '_blank');
       console.log(url);

  //       $.ajax({
		// 	url: "<?php echo e(route('download.pdf')); ?>",
  //           type: "get",
  //           'headers': {
...
<?php /**PATH E:\ocosystem\resources\views/itemized_sales_report/itemized_sales_report.blade.php ENDPATH**/ ?>