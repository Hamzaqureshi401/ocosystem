...
weekDayName : 'SUN MON TUES WED THURS FRI SAT'.split(' '),
...
init: function() {
    ...
    $('.date_table > tbody > tr > td').click(function(e) {
        ...
        let month  = $('.month-year > h3').html();
          ...
          //     // $('.date_table > tbody > tr > td').on("click",function(e) {
          //   //   $(this).addClass("selected_date")
          //   // })  
          //   $(target).addClass('selected_date');
 
          //   localStorage.setItem("dt","1")
          //   localStorage.setItem("startTransDate",new Date(day+' '+month))
          //   $('#trans_start_date').val(dateToYMD(new Date(day+' '+month)));

          //   jQuery('#showDateModalFrom').modal('hide');
           
          //   // osmanli_calendar.SELECT_DATE = (((day)+' '+month))
          ...
          // }else{
            ...
            if (osmanli_calendar.ON_SELECT_FUNC != "OFF") {
              if( osmanli_calendar.SELECT_DATE == 'Invalid Date'){
                 return false;
              }
